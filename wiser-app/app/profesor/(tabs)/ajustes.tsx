...
export default function ProfesorAjustes() {
  ...
  const opciones = [
    { icon: 'person-outline' as const, label: 'Mi perfil', onPress: () => router.push('/profesor/mi-perfil') },
    { icon: 'settings-outline' as const, label: 'Ajustes de cuenta', onPress: () => router.push('/profesor/ajustes-cuenta') },
    { icon: 'help-circle-outline' as const, label: 'Preguntas frecuentes', onPress: () => router.push('/profesor/preguntas-frecuentes') },
  ];
